...
import { Search, Plus, Minus, RotateCcw, ShoppingCart, ScanLine, Image as ImageIcon, CheckCircle, AlertCircle, X, Banknote, QrCode, Lock, AlertTriangle, User } from 'lucide-react';
