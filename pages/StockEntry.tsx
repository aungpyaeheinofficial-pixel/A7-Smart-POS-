      ...
      try {
         ...
         for (const entry of gridData) {
            ...
            if (existing) {
               ...
               // Ensure price is greater than 0 to pass API validation.
               // If user didn't enter a selling price, use the cost price. 
               // If cost price is 0, default to a minimum of 1.
               const validSellingPrice = entry.sellingPrice > 0
                  ? entry.sellingPrice
                  : (entry.costPrice > 0 ? entry.costPrice : 1);
