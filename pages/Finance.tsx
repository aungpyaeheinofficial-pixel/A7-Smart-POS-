...
const Finance = () => {
  ...
  const stats = useMemo(() => {
    ...
    // 2. Expense Stats (Combine Transactions type=EXPENSE + Finance Expenses)
    // Note: In some systems these are separate, here we aggregate for the KPI
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
         ...
         <KPICard 
           title="Net Profit" 
           value={`${(stats.netProfit/1000000).toFixed(2)}M`} 
